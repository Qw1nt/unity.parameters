...
namespace Parameters.Runtime.Base
{
    ...
    public class ParameterData : ScriptableObject, IParameterFactory, IParameterStaticIdSetter, IParameterData
    {
        ...
        [SerializeField, SerializeReference, HideInInspector] public object Data;
